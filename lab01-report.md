...
**Обгрунтування**: Виконав всі завдання рівнів 1 та 2. Встановив зєднання з облачною СУБД Supabase, дослідив структуру бази даних та оволодів основними операторами SQL: SELECT, WHERE, LIKE, AND/OR/NOT, IN, BETWEEN, ORDER BY, LIMIT, OFFSET.
